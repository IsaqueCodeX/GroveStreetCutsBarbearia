  ...
  return (
    <section className="relative w-full h-[100dvh] min-h-[100dvh] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center justify-center h-full pt-16 md:pt-0">
        ...
        >
          <span className="font-display text-4xl md:text-7xl block mb-2">BEM-VINDO A </span>
          <span
            className="font-accent text-grove-green text-[3.5rem] leading-[0.9] md:text-8xl lg:text-9xl block mt-2"
            style={{ textShadow: "0 0 40px hsl(137 60% 44% / 0.6)" }}
          >
            LOS SANTOS.
          </span>
        </motion.h1>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-4 justify-center w-full md:w-auto"
        >
          <a
            href="#cuts"
